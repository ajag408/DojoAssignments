...
-- -----------------------------------------------------
-- Table `login_reg`.`messages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `login_reg`.`messages` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `login_reg`.`comments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `login_reg`.`comments` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_comments_messages1`
    ...
    REFERENCES `login_reg`.`messages` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
